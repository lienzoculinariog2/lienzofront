...
const mockProducts: IProduct[] = [
{
    ...
    description: "Es una milanesa que además tiene arroz. Es una milanesa con arroz.",
    price: 450.0,
    stock: 3,
    imgURL: "https://ik.imagekit.io/xiqknvpxxh/Lienzo%20Culinario/Gemini_Generated_Image_q8noseq8noseq8no.png?updatedAt=1754607553700",
    isActive: true,
...
},
{
    ...
    description: "Es una milanesa que no tiene arroz. Es una milanesa sin arroz.",
    price: 400.0,
    stock: 5,
    imgURL: "https://ik.imagekit.io/xiqknvpxxh/Lienzo%20Culinario/Gemini_Generated_Image_6k2jo76k2jo76k2j.png?updatedAt=1754607408351",
    isActive: true,
...
return (
    ...
    {isLoading && (
        <p className="text-center text-lg text-primary-txt-400 mt-8">Cargando productos...</p>
    )}
